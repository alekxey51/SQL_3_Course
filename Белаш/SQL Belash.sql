...
update марка set мName = 'Митсубиси' where мName = 'Фиат'
update марка set мName = 'Феррари' where мName = 'Тойота'
...
insert into автомобиль(acost,dveri,mesta,IDM) values (670,4,6,3)

update автомобиль set acost = 450 where acost = 300
update автомобиль set acost = 467 where acost = 1005
update автомобиль set dveri = 10 where acost < 1000 and acost > 300 
...
insert into клиент(FIO,number_of_house,number_of_flat,DateOfBirth,klAge,PhoneNumber,IDY) values ('Х.Н.А.',16,15,'2002-08-22',17,375296948455,3)
